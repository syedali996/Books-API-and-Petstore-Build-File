...
This is a guided walkthrough that will showcase adding a pet record and then using the pet ID to fetch the details of the pet. 
...
5. Now click on **Try it Out** button to fetch information on entered in the **Step 1**.`);
      },
    },
    "Step 2": {
      name: "Add New Pet",
